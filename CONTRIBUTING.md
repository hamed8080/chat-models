...
Thank you for considering contributing to ChatModels.

Please know that everyone is welcome to contribute to ChatModels.
...
ChatModels is an open source project and we encourage contributions
from the community.

### Contributing Code and Documentation

Before contributing code or documentation to ChatModels,
we encourage you to first open a 
[GitHub issue](https://github.com/hamed8080/chat-models/issues/new/choose) 
...
All changes to ChatModels source must go through the PR review process before
...
ChatModels is a Swift package. If you're new to Swift package manager,
...
1. Checkout this repository using:
    ...
    ```bash
    git clone git@github.com:hamed8080/chat-models.git
    ```
...
4. Build ChatModels from the command line by running:
